...
import { georgeLogo,menu, close } from "../assets";
const Navbar = () => {
  ...
  >
    ...
    items-center max-w-7xl mx-auto">
      ...
      >
        <img src={georgeLogo} alt="logo" className="w-9
        h-9 object-contain" />
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        <div className={`${!toggle ? 'hidden' : 'flex'}
         p-6 black-gradient absolute top-20 right-0 m
         x-4 my-2 min-w-[140px] z-10 rounded-xl`
         }>
